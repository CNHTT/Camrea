...
import static com.cd.avatar.FileUtils.getDataColumn;
import static com.cd.avatar.FileUtils.isDownloadsDocument;
import static com.cd.avatar.FileUtils.isExternalStorageDocument;
import static com.cd.avatar.FileUtils.isGooglePhotosUri;
import static com.cd.avatar.FileUtils.isMediaDocument;
...
public class PhotoUtils {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        Log.d("AAA", "生成的照片输出路径：" + imageFilePath[0].toString());
     ...
     * @return 图片的uri
     */
    public static Uri createImagePathUri(final Context context,String filePath) {
        final Uri[] imageFilePath = {null};
